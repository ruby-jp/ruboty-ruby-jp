  ...
  module Handlers
    class Golf < Base
      ...
      def topic(message)
        ...
        # When topic is longer than 250 characters, returns {"ok"=>false, "error"=>"too_long"}.
        if new_topic.size > 250 - 3
          while new_topic.size > 250 - 3
            new_topic = new_topic.lines[0..-2].join
          end
          new_topic << "..."
        end
